...
## Differences got a bit more substantial in this next set of loops I skipped
## merging for now
...
> diff -U 999999 combined.R combined_by_protein.R
--- combined.R  2014-08-04 16:30:30.000000000 -0700
+++ combined_by_protein.R       2014-08-04 16:30:30.000000000 -0700
@@ -1,205 +1,261 @@
 uniq.tryptic.sequence <- function( raw.sequence ) {
   ## find the smallest tryptic fragment with the labeling sites
   seq.vec <- unlist(strsplit(raw.sequence,""))
